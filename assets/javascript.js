...
$(document).on('click', '.clickable', 'total()', function (event) {
    ...
    $.ajax({
        ...
        .then(function (response) {
            ...
            var xDiv = $('<span class="delete" data-calsum=' + calories + '> <i class="fa fa-trash" aria-hidden="true"></i> </span></div>');
...
$(document).on('click', '.delete', function () {
    var caloriesToRemove = $(this).data("calsum");
    sum -= caloriesToRemove;
    $("#total").empty();
    var totalDiv = $('<span>');
    var totalContainer = $('<div>').addClass("totalDiv");
    totalContainer.append(totalDiv);
